...
public class AmountUtils {
    ...
    /**
      * 方法表述: 将分为单位的转换为元并返回金额格式的字符串 （除100）
      * @Author zoujiulong
      * @Date 9:57 2019/10/21
      * @param       amount
    ...
    */
    ...
    /**
      * 方法表述: 将分为单位的转换为元 （除100）
      * @Author zoujiulong
      * @Date 9:58 2019/10/21
      * @param       amount
      * @return java.lang.String
    */
    ...
    */
    ...
    /**
      * 方法表述: 将元为单位的转换为分 替换小数点，支持以逗号区分的金额
      * @Author zoujiulong
      * @Date 9:58 2019/10/21
      * @param       amount
      * @return java.lang.String
