...
public class BaiduConsumer {
    public static void main(String[] args) {
        ...
        try {
            ...
            // 参数一：队列名
            //参数三：路由key(暂时用不到)
            channel.queueBind(RabbitConstant.QUEUE_BAIDU,RabbitConstant.EXCHANGES_WEATHER_ROUTING,
                    "Chine.guangdong.shenzhen.20190515");
            channel.queueBind(RabbitConstant.QUEUE_BAIDU,RabbitConstant.EXCHANGES_WEATHER_ROUTING,
                    "Chine.guangdong.shenzhen.20190516");
            channel.basicQos(1);
